---
title: 2024年在codespace使用mdbook记录
date: 2024-11-15 08:45:51
tags:
---
codespace没有预装mdbook，要先装rust再装mdbook等，命令如下
```
...
把书籍弄完后，mdbook的目录要手动编写，于是找了个自动生成目录的py脚本：
https://github.com/lzzsG/mdBook-tools/blob/main/mdBook-directory-summary-generator/generate_summary.py
...
在GitHub pages放网页只能放根目录，这样用mdbook或者hexo之类生成的内容的源码想同时保存，要多开一个repositories；或者在repositories下用不同的branch保存，好麻烦，弄了半天。
